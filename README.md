...
```
git remote set-url origin https://github.com/kimsumin75/lsbeat
...
```
mkdir -p ${GOPATH}/github.com/kimsumin75
cd ${GOPATH}/github.com/kimsumin75
git clone https://github.com/kimsumin75/lsbeat
```
